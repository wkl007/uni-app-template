...
const DEFAULT_SHARE_TITLE = '公众号标题'
const DEFAULT_SHARE_LINK = 'https://www.test.com'
const DEFAULT_SHARE_IMG = '公众号图片'
export const DEFAULT_SHARE_DESC = '公众号描述'
...
export const isWeChat = () => {
  const flag = window.navigator.userAgent.toLowerCase()
  return flag.match(/micromessenger/i) === 'micromessenger'
}
 ...
 */
export const wxConfig = (jsApiList = ['updateAppMessageShareData', 'updateTimelineShareData']) => {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    const { appId, timeStamp, nonceStr, signature } = (await CommonServer.getShareSignature(data)).data
    wx.config({
